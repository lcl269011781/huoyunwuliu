 ...
 */
@Service
public class VehicleLengthServiceImpl implements VehicleLengthService {

    @Resource
    private VehicleLengthMapper vehicleLengthMapper;

    @Override
    public List<VehicleLength> getVehicleLengthList() {
        return vehicleLengthMapper.selectVehicleLengthList();
    }
}
